...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_SYMB] =   LAYOUT(MC_GRV_ESC, A(KC_F1), _______, _______, _______, _______,        C(KC_F6), C(KC_PSLS), _______, _______, _______, _______,
                       _______, _______, _______, EU_EUR, _______, _______,             _______, UML_UE, _______, UML_OE, _______, _______,
