...
tap_dance_action_t tap_dance_actions[] = {[TD_F1_F11] = ACTION_TAP_DANCE_DOUBLE(KC_F1, KC_F11), [TD_F2_F12] = ACTION_TAP_DANCE_DOUBLE(KC_F2, KC_F12), [TD_UML_AE] = ACTION_TAP_DANCE_FN(auml_tap_dance), [TD_UML_OE] = ACTION_TAP_DANCE_FN(ouml_tap_dance), [TD_UML_UE] = ACTION_TAP_DANCE_FN(uuml_tap_dance), [TD_SS] = ACTION_TAP_DANCE_FN(ger_sz_tap_dance), [TD_EU_EUR] = ACTION_TAP_DANCE_FN(eur_tap_dance)};
