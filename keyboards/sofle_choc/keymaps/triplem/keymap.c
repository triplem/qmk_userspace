...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------|                   |------+------+------+------+------+------|
     * |LShift|A GUI |S ALT |D CTL |F SFT |G MO2 |------.    ,-------|H MO1 |J SFT |K CTL |L ALT |; GUI |  '   |
     * |------+------+------+------+------+------| HOME |    |  MUTE |------+------+------+------+------+------|
    ...
    [_QWERTY] = LAYOUT(MC_TLD_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
                       ...
                       KC_LSFT, MOD_A, MOD_S, MOD_D, MOD_F, LT_G, LT_H, MOD_J, MOD_K, MOD_L, MOD_SCLN, MC_QUOT,
     ...
     *            `----------------------------------'           '------''---------------------------'
     */
    [_SYMB] =   LAYOUT(MC_GRV_ESC, A(KC_F1), _______, _______, _______, _______,        C(KC_F6), C(KC_PSLS), _______, _______, _______, KC_EQUAL,
                       _______, _______, _______, EU_EUR, _______, _______,             _______, UML_UE, _______, UML_OE, _______, KC_PIPE,
                       _______,  UML_AE, GER_SZ, _______, _______, _______,        _______, _______, _______, _______, _______, KC_BSLS, _______,
