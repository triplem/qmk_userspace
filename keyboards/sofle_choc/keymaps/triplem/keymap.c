...
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  MOD_A,  MOD_S,   MOD_D,   MOD_F,   KC_G,                     KC_H,    MOD_J,    MOD_K,   MOD_L,MOD_SCLN,    KC_QUOT,
    KC_LCTL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_HOME,  KC_MUTE, KC_N,     KC_M,  KC_COMM,    KC_DOT,  KC_SLSH, KC_RSFT,
 ...
 */
 [_FUNCTION] = LAYOUT(
    ...
    RGB_TOG, _______, _______, _______, _______, KC_LBRC,                       KC_RBRC, _______, _______, KC_F11,  KC_F12,  _______,
    RGB_MOD, _______, _______, _______, _______, _______,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, _______,
   RGB_RMOD, _______, _______, _______, _______, _______, _______,     _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END , _______, _______,
