 ...
 */
[_QWERTY] = LAYOUT(
    TD_ESC_GRV,  KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,     KC_7,     KC_8,    KC_9,    KC_0,    KC_BSPC,
    KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,     TD_UML_UE,     KC_I,    TD_UML_OE,    KC_P,    KC_MINUS,
    KC_LSFT,  TD_UML_AE,  TD_SS,   MOD_D,   MOD_F,   LT_G,                     LT_H,    MOD_J,    MOD_K,   MOD_L,MOD_SCLN,    KC_QUOT,
