 ...
 */
[_QWERTY] = LAYOUT(
    MC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,     KC_7,     KC_8,    KC_9,    KC_0,    KC_BSPC,
    KC_TAB,   KC_Q,   KC_W,  TD(TD_EU_EUR),    KC_R,    KC_T,                     KC_Y,     TD(TD_UML_UE),     KC_I,    TD(TD_UML_OE),    KC_P,    KC_MINUS,
    KC_LSFT,  TD(TD_UML_AE),  TD(TD_SS),   MOD_D,   MOD_F,   LT_G,                     LT_H,    MOD_J,    MOD_K,   MOD_L,MOD_SCLN,    MC_QUOT,
 ...
 */
 [_FUNCTION] = LAYOUT(
    ...
    RM_NEXT, _______, _______, _______, _______, _______,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, _______,
    RM_PREV, _______, _______, _______, _______, _______, _______,     _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END , _______, SC_CAD,
...
[_CODING] = LAYOUT(
    ...
    _______, UML_AE,    GER_SZ, _______, _______, _______,                       _______,  _______,    _______, _______, _______, _______,
